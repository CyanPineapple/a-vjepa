...
def init_data(
    ...
    elif data.lower() == 'videotextdataset':
        from src.datasets.video_text_dataset import make_video_text_dataset
        dataset, data_loader, dist_sampler = make_video_text_dataset(
            data_paths=root_path,
            batch_size=batch_size,
            frames_per_clip=clip_len,
            frame_step=frame_sample_rate,
