...
def make_video_text_dataset(
    ...
    logger.info('VideoTextDataset dataset created')
    ...
    logger.info('VideoTextDataset unsupervised data loader created')
...
class VideoTextDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        # Load video paths and text (ignore the variable name, label == text)
        samples, labels = [], []
