...
def make_mmencdataset(
    ...
    logger.info('MmencDataset dataset created')
    ...
    logger.info('MmencDataset unsupervised data loader created')

    return dataset, data_loader, dist_sampler


class MmencDataset(torch.utils.data.Dataset):
    """ Mmenc classification dataset. """
